...
public class AddProfilePictureSteps extends CommonMethods {
    ...
    public void user_handles_the_expected_response_status_with_alert(String status, String expectedError) {
        if (status.equalsIgnoreCase("SUCCESS")) {
            ...
            try {
                org.openqa.selenium.support.ui.WebDriverWait shortWait = new org.openqa.selenium.support.ui.WebDriverWait(DriverFactory.getDriver(), java.time.Duration.ofSeconds(4));

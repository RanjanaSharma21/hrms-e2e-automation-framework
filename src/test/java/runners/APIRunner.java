...
@CucumberOptions(
        ...
        // path of the ui.steps package, name must be same
        glue = "api.steps",
        ...
        //tags = "@lombokpojo",
         //tags = "@apilogin",
        //tags = "@apiCrudIntegration or @lombokpojo or @map or @rawjson or @dynamicjson",
        // local reference for  qa
        // pretty - it prints all the ui.steps in console, so that you can check which is failing with links
        plugin = {"pretty",
                "html:target/api-cucumber.html",
                "json:target/jsonReports/api-cucumber.json",
